...
ALLOWED_RECOVERYOS_VERSIONS = ("13.5", "15.4")

# MacOS 15.x+ is always safe
MAC_OS_15_PLUS_SAFE = True
...
def run_checks(main):
    ...
    # Check if running macOS 15 or newer (automatically safe)
    if main.sysinfo.macos_ver and MAC_OS_15_PLUS_SAFE and main.sysinfo.macos_ver.startswith("15."):
        logging.info("bugs: macOS 15+ detected, which is automatically safe")
        return
